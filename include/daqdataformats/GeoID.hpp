...
GeoID::GeoID(SystemType const& type, uint16_t const& region, uint32_t const& element); // NOLINT(build/unsigned)
...
SystemType GeoID::string_to_system_type(std::string typestring)
{
